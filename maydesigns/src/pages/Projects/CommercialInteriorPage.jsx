        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact-us"
                className="bg-indigo-500 text-white px-8 py-4 rounded-lg font-semibold hover:bg-indigo-600 transition-colors flex items-center justify-center"
              >
                Start Your Commercial Project
                <FiArrowRight className="ml-2" />
              </Link>
              <button className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg font-semibold hover:border-indigo-500 hover:text-indigo-500 transition-colors">
    ...
    >
      ...
      <div className="p-8">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-2xl font-bold text-gray-900 group-hover:text-indigo-500 transition-colors">
            {project.name}
          </h3>
        ...
        <div className="flex items-center justify-between pt-6 border-t border-gray-100">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Link
              ...
              className="bg-indigo-500 text-white px-6 py-2 rounded-lg hover:bg-indigo-600 transition-colors font-semibold flex items-center group/link"
            >
              Explore
